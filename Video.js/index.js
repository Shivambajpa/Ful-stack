              ...
              <div className=" bg-orange-300   pt-4 ">
                ...
                <div className="grid grid-cols-3 bg-orange-300  pt-8 gap-5  p-8 justify-center      text-center      mt-4  ">
                  ...
                  <div className="text-center  bg-slate-200  border-white border-4  justify-center ">
                    ...
                    <p className="">
                      {" "}
                      Even when not actively playing, reserve players support
                      the team by cheering, offering encouragement, and helping
                      maintain a positive atmosphere on the sidelines.They stay
                      ready to enter the game at any time, warming up regularly
                      and paying attention to the flow of the match. While on
                      the bench, reserves can closely watch the opponent’s
                      strategies, patterns,.
                    </p>{" "}
                  </div>
                  <div className="text-center  bg-slate-200  border-white  border-4 items-center justify-center">
                    ...
                    <p className="">
                      ...
                      spiking, and blocking. Emphasis is placed on building
                      strong communication skills on the court and fostering a
                      sense of teamwork and camaraderie. Coaches aim to build
                      players' confidence, encouraging them to take on
                      challenges,.
                    </p>
                  </div>
                </div>
